...
export function InvoicePreview({ data, onPdfSaved }: InvoicePreviewProps) {
  ...
  return (
    <div ref={printRef} className="mx-auto max-w-4xl bg-white p-4 sm:p-12">
      ...
      <hr className="border-b-2-0 border-gray-200" />

      <div className="mt-5 w-full">
        <div className="flex w-full flex-col gap-y-1">
          <div className="grid grid-cols-2 border border-gray-200 bg-gray-100 p-2">
        ...
        <div className="flex w-full gap-7">
          <div className="mt-5 flex-1">
            <p className="border-b border-b-gray-400 text-xs font-bold">BANK DETAILS</p>
          ...
          <div className="mt-5 flex-1">
            <p className="border-b border-b-gray-400 text-xs font-bold">BILL TO:</p>
      ...
      <div className="mt-5 overflow-x-auto -mx-4 sm:mx-0">
        <table className="w-full table-auto">
          ...
          <tfoot>
            <tr className="h-8 border border-gray-200 bg-gray-100 text-end">
      ...
      <div className="mt-5 w-full">
        <p className="border-b border-b-gray-400 text-xs font-bold">EXTRAS</p>
      ...
      <div className="mt-5 flex justify-end">
        <table className="w-full border-collapse sm:w-64">
          <thead className="h-5 w-[64px]">
            <tr>
              <th className="border-r border-gray-200 bg-gray-100 px-2 text-start text-base">
                SUBTOTAL
              </th>
          ...
          <tbody>
            <tr>
              <td className="border-r border-gray-200 bg-gray-100 px-2 text-base font-bold">
                GST
              </td>
